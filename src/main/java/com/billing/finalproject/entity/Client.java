...
public class Client {
    ...
    @Schema(description = "Client Name", example = "Juan", requiredMode = Schema.RequiredMode.REQUIRED)
    private String clientName;

    @Schema(description = "Client Lastname", example = "Perez", requiredMode = Schema.RequiredMode.REQUIRED)
